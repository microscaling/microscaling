...
import (
	...
	//"net/http"
	"os"
	"github.com/force12io/force12-scheduler/f12_marathon" //AEC I NEED TO SUB THIS INTO AN INTERFACE SO I CAN SUB IN ECS VERSION OF PACKAGE, WHOSE INTERFACE WILL BE IDENTICAL
)
